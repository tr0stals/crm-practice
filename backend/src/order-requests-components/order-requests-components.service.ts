...
export class OrderRequestsComponentsService {
  ...
  async create(data: Partial<OrderRequestsComponents>): Promise<OrderRequestsComponents> {
  ...
  async update(id: number, data: Partial<OrderRequestsComponents>): Promise<OrderRequestsComponents> {
