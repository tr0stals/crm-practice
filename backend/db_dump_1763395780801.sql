...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '6d593d94-be05-11f0-9cf8-9c6b00b99192:1-528';
...
INSERT INTO `departments` VALUES (1,'IT'),(2,'Снабжение'),(3,'Производство');
...
INSERT INTO `employee_departments` VALUES (1,1,2),(2,2,3),(3,3,4),(4,3,5);
...
INSERT INTO `employees` VALUES (1,NULL,NULL,1),(2,'2025-10-13',NULL,2),(3,'2025-10-14',NULL,3),(4,'2025-07-21',NULL,4),(5,'2025-07-01',NULL,5);
...
INSERT INTO `employees_professions` VALUES (1,1,1),(2,2,6),(3,3,5),(4,4,11),(5,5,17);
...
INSERT INTO `images` VALUES (1,'file-1763286159186-296447841.jpg','flagRussia.jpg','image/jpeg',563919,'uploads/file-1763286159186-296447841.jpg',NULL,'2025-11-16 14:42:39.193981','stands',1),(2,'file-1763394280796-863013323.jpg','flagRussia.jpg','image/jpeg',563919,'uploads/file-1763394280796-863013323.jpg',NULL,'2025-11-17 20:44:40.801040','stand_tasks',2),(3,'file-1763394341123-488902683.jpg','flagRussia.jpg','image/jpeg',563919,'uploads/file-1763394341123-488902683.jpg',NULL,'2025-11-17 20:45:41.125709','stand_tasks',3);
...
INSERT INTO `license` VALUES (3,'12312313','2025-11-04','2025-11-19',123,'13:03:00','123',3,1);
...
INSERT INTO `license_types` VALUES (3,'Стандарт');
...
INSERT INTO `organization_types` VALUES (1,NULL,'Фабрика'),(2,NULL,'Перевозчик'),(3,NULL,'Производитель'),(4,NULL,'Клиент');
...
INSERT INTO `peoples` VALUES (1,'admin','admin','admin','+79999999999','info@apracticum.ru','Супер администратор системы','1999-11-30'),(2,'Павел','Сергеевич','Бекарев','895834928585','bekarev.ps@gmail.com',NULL,'2025-06-25'),(3,'Семен','Семенович','Семенов','89348598435','petr@mail.ru',NULL,'2025-09-23'),(4,'Максим','Максимвич','Максимов','13555876987','vas@mail.ru',NULL,'2024-08-22'),(5,'Маляр','Малярович','Маляров','678678768','malyar@mail.ru',NULL,'2025-11-03');
...
INSERT INTO `professions` VALUES (1,'Администратор'),(2,'Директор'),(3,'Бухгалтер'),(4,'Зав. производством'),(5,'Снабженец'),(6,'Программист'),(7,'Дизайнер'),(8,'Конструктор'),(9,'Инженер'),(10,'Монтажник'),(11,'Слесарь'),(12,'Токарь'),(13,'Фрезеровщик'),(14,'Сварщик'),(15,'Столяр'),(16,'Технолог ПП'),(17,'Покрасчик'),(18,'Test');
...
INSERT INTO `stand_tasks` VALUES (2,NULL,1,NULL,'Собрать по инструкции','flagRussia.jpg',2,1,11,NULL),(3,NULL,2,NULL,'Покрасить стенд в белый цвет','flagRussia.jpg',3,1,17,NULL);
...
INSERT INTO `stand_tasks_components` VALUES (2,NULL,2,NULL),(3,NULL,3,NULL);
...
INSERT INTO `stands` VALUES (1,NULL,'123','flagRussia.jpg','13','123','123',123,123,'https://acidic-papa.com/','123',123,'1',1,1);
...
INSERT INTO `stands_types` VALUES (1,'asd');
...
INSERT INTO `user` VALUES (1,'admin','123','$2b$10$d9GV709NCp./9OL1MZ5lG.cxk.vck5UxNAH0dzWSJzdj/eP/2Q3he',1),(2,'malyar','123','$2b$10$ZDtap7G4GzrDw1uQVlOdoO9sich56eLWTyi05.yU22shRJk8sGzGm',5),(3,'max','123','$2b$10$lSehWf52yj86/3Vfgfdv5.JFGR483.BsaAfVuz.jfiCjZEO4HmjYO',4);
...
-- Dump completed on 2025-11-17 21:09:40
